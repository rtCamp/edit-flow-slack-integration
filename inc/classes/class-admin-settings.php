...
class Admin_Settings {
	...
	public function slack_notification_webhook_settings() {
		...
		add_settings_field( 'edit_flow_slack_webhook', __( 'Edit Flow Slack Webhook', 'edit-flow-slack-integration' ), array( $this, 'slack_notification_webhook_settings_html' ), 'general' );
	}
