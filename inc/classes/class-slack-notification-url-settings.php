...
class Admin_Settings {
	...
	public function slack_notification_webhook_settings() {
		...
		add_settings_field( 'slack_notification_url_settings', __( 'Edit Flow Slack Webhook', 'slack_notification_url_settings' ), array( $this, 'slack_notification_webhook_settings_html' ), 'general' );
	}
	...
	public function slack_notification_webhook_settings_html() {
		...
		printf( '<input type="text" id="Z" name="slack_notification_url_settings" class="regular-text ltr" value="%1$s"/>', esc_url( $value ) );
	}
