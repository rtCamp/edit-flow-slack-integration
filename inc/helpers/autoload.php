...
function autoloader( $resource = '' ) {
	...
	$resource_path  = false;
	$namespace_root = 'Edit_Flow_Slack_Integration\\';
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( WP_EDIT_FLOW_SLACK_PLUGIN_PATH ), $directory, $file_name );
...
spl_autoload_register( '\Edit_Flow_Slack_Integration\Inc\Helpers\autoloader' );
