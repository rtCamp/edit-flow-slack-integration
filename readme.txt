...
Edit flow slack integration plugin sends a notification contains commenter name, comment message and commented post name on your slack channel when user do editiorial comment.
